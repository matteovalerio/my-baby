...
import com.matteo.mybaby2.modules.activities.entities.ActivityEntity
...
@Database(
    entities = [ActivityEntity::class, BreastFeedingEntity::class, PoopingEntity::class, BabyEntity::class],
    version = 1
)
